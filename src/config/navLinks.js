...
export function buildNavLinks(clubData) {
  return [
    ...
    },
    {
      ...
      hasDropDown: true,
      subLinks: [
        { name: "2026-27 Student Body Council", to: "SBC" },
        { name: "2027 Senior Board", to: "Senior Board" },
        { name: "2028 Junior Board", to: "Junior Board" },
        { name: "2029 Sophomore Board", to: "Sophomore Board" },
        { name: "2030 Freshman Board", to: "Freshman Board" },
        {
          name: "Committees",
          hasDropDown: true,
          to: "Commitees",
