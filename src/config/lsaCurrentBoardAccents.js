...
export function getLsaCurrentBoardAccent(boardKey) {
  ...
  if (boardKey === "Senior Board") return META["2027"]?.color ?? "#9c1919";
  if (boardKey === "Junior Board") return META["2028"]?.color ?? "#1565c0";
  if (boardKey === "Sophomore Board") return META["2029"]?.color ?? "#6a1b9a";
  if (boardKey === "Freshman Board") return META["2030"]?.color ?? "#2e7d32";
