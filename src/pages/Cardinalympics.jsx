...
<div className="event">
    ...
    <p className="event-description"><strong>Description:</strong>  Did you do a great job designing and showing off your Old-Money outfit? Come to the catwalk and compete for “best dressed.” There will be one contest for each lunch block.</p>
...
<div className="event">
    ...
    <p className="event-description"><strong>Where:</strong>  The Catwalk</p>
    <p className="event-description"><strong>Host:</strong>  SBC</p>
    <p className="event-description"><strong>Description:</strong>  Did you do a great job designing and showing off your Tourist Tuesday outfit? Come to the catwalk and compete for “best dressed.” There will be one contest for each lunch block.</p>
...
<div className="event">
    ...
    <p className="event-description"><strong>Where:</strong>  the Catwalk</p>
    <p className="event-description"><strong>Host:</strong>  SBC</p>
    <p className="event-description"><strong>Description:</strong>  Did you do a great job designing and showing off your Wake-Up Wednesday outfit? Come to the catwalk and compete for “best dressed.” There will be one contest for each lunch block.</p>
...
<div className="event">
    ...
    <p className="event-description"><strong>Where:</strong>  The Catwalk</p>
    <p className="event-description"><strong>Host:</strong>  SBC</p>
    <p className="event-description"><strong>Description:</strong>  Did you do a great job designing and showing off your Thermal Thursday outfit? Come to the catwalk and compete for “best dressed.” There will be one contest for each lunch block.</p>
