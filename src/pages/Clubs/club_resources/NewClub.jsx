    ...
    return(
        <>  
            ...
            <section className="info-page">
                ...
                <p>Before you can start meetings, you must fill out a couple of forms and get them approved by the SBC Club Coordinator. All of these MUST be filled out by the deadline in order to begin the process of starting a new club. All forms should preferably be signed digitally. Please email lowellclubcoord25@gmail.com with any questions or concerns.</p>
