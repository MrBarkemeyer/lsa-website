      ...
      <div className="mock-trial-content">
        ...
        <article className="mock-trial-card">
          ...
          <div className="mock-trial-grid">
            <div className="mock-trial-feature">
              ...
              <p>
                Practice argumentation, questioning, and persuasive speaking in
                a structured, high-impact setting.
              </p>
            </div>
            <div className="mock-trial-feature">
        ...
        <article className="mock-trial-card mock-trial-card--contact">
          ...
          <ul className="mock-trial-contact-list">
            <li>
              <strong>Michael Ungar</strong> - ungarm@sfusd.edu
            </li>
            <li>
              <strong>Lisa Hathaway</strong> - lhathaway13@gmail.com
            </li>
            <li>
              <strong>Lauretta Komlos</strong> - komlosl@sfusd.edu
            </li>
            <li>
              <strong>Nikole Gorin</strong> - nikolegorin@gmail.com
            </li>
          </ul>
          <p>
            <strong>Instagram:</strong> @lowellmocktrial
          </p>
          <a
            href="mailto:lowellhsmocktrial@gmail.com"
            className="mock-trial-email"
          >
