    ...
    <>
      <div className="title">
        ...
        <p className="about-lsa-tagline">
          Student government boards for every grade
        </p>
      </div>
      ...
      <div className="about-lsa">
        <section className="about-lsa-section">
          ...
          <div className="about-lsa-cards">
            <div className="about-lsa-card">
              ...
              <p>
                Runs school-wide events and amplifies student voice across
                Lowell.
              </p>
        ...
        <section className="about-lsa-section">
          <h2>How to join</h2>
          <p>
            LSA elections happen throughout the year. In the fall, the Freshman
            Board is selected. In the spring, other grades (except seniors) can
            run for SBC and their class board.
          </p>
