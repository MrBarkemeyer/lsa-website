      ...
      <div className="about-lsa">
        <section className="about-lsa-section about-lsa-intro">
          <p>
            ...
            student government - all the boards together - including the Student
            Body Council (SBC) and class boards for Seniors, Juniors,
          ...
          <div className="about-lsa-cards">
            <div className="about-lsa-card">
              ...
              <p>
                ...
                Rallies, Winterball, Last Dance, Co-Curricular Day, and more. We
                amplify the student voice and make changes based on what
                students want.
              </p>
              ...
              <Link to="SBC" className="about-lsa-card-link">
                Meet the SBC &rarr;
              </Link>
            </div>
            <div className="about-lsa-card">
              ...
              <p>
                ...
                events like prom, boat, and graduation, and build class spirit
                with smaller events and bonding activities.
              </p>
              <p className="about-lsa-roles">
                <strong>Positions:</strong> President, Vice President,
                Secretary, Treasurer, Historian, Public Relations.
              </p>
              <Link to="/LSA-EXPLORE" className="about-lsa-card-link">
                Explore LSA &rarr;
              </Link>
            </div>
          </div>
        ...
        <section className="about-lsa-section">
          ...
          <p>
            ...
            We&apos;re there during 1st block Leadership. You can also reach out
            to any LSA member at school; photos and info are in the &quot;Meet
            the Members&quot; section.
          </p>
        </section>

        <Link to="Charter" className="about-lsa-charter-cta">
          <span className="about-lsa-charter-title">
            Charter of the Lowell Student Association
          </span>
          <span className="about-lsa-charter-desc">
            Read our governing rules and bylaws
          </span>
        </Link>
      </div>
    </>
