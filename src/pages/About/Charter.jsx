    ...
    sections: [
      {
        title: "Section 1.",
        paragraph:
          "The judicial power of the Lowell Student Body shall be vested in an Association of Student Arbitration (ASA). Members of the ASA may not simultaneously hold any student elected or appointed position within the school. The members of the ASA shall hold office until the completion of their senior year, and during good behavior. ",
      },
      {
        title: "Section 2.",
        paragraph:
          "The ASA shall have the power to interpret this charter when questions or conflict arise between the two or more class boards; -questions and conflict between SBC and any number of class boards; question or conflict between members of the Lowell student government and any level of student government. ",
      },
      {
        title: "Section 3.",
        paragraph:
          "The SBC President shall have the sole power to nominate candidates for the ASA. Members of the ASA are appointed with the consent of two-thirds of membership of the class  boards. The ASA shall not exceed more than five members.",
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: "Section 2.",
        paragraph:
          "During a meeting of the LSA each class board shall have the right to discuss a brief state of the class. In addition, any class officer may introduce a proposal to SBC. The proposals must be submitted to the SBC Vice President one week prior to the meeting and they are given the authority to determine the order in which the proposals will be discussed. A majority vote by the members of the class boards is required for the proposal to be reviewed by SBC. SBC must submit a response to the class boards within seven school days from the meeting or else the  proposal becomes a requirement for SBC.",
      },
      {
        title: "Subsection 1.",
        paragraph:
          "Proposals are defined as any plan or suggestions put forth by any member of the LSA to be discussed and considered. Proposals are any and all recommendations and additions to the LSA, acted upon by the entire LSA.",
      },
      {
        title: "Section 3.",
        paragraph:
          "If matters of the LSA meeting are left unresolved, it is required that two-thirds of the LSA agree to continue the session to the next school day available.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        title: "Section 1.",
        paragraph:
          "Endangerment to the classes, the school, or the interpretation of the Charter is a crime worthy of impeachment. When this is in question, the student arbiters shall be given the sole  power to call for impeachment proceedings, which will be presided by the Director of Arbitration. The combination of all of SBC and LSA members must be present throughout the  proceedings. ",
      },
      {
        title: "Section 2.",
        paragraph:
          "Prior to the proceedings the defendant has the opportunity to resign from public office and if so no judgment shall be set forth.",
      },
      {
        title: "Section 3.",
        paragraph:
          "No person shall be convicted without the concurrence of two-thirds of the members  present. Judgment in cases of impeachment shall be restricted to the removal from office and the disqualification to hold any further office under Lowell Student Government.",
      },
      {
        title: "Section 4.",
        paragraph:
    ...
    sections: [
      {
        title: "Section 1.",
        paragraph:
          "The San Francisco Unified School District and the Lowell High School administration have domain over the LSA. The SBC guarantees the rights stated within the Charter, however, if the rights are in conflict with a higher authority there is no longer an assured  protection. ",
      },
      {
        title: "Section 2.",
        paragraph:
          "Lowell students have the freedom of opinion expressed through speech, attire, and  petition.",
      },
      {
        title: "Section 3.",
        paragraph:
          "Lowell students may find fault with student government and file suits through the ASA.",
      },
      {
        title: "Section 4.",
        paragraph:
          "Lowell students are guaranteed the right to vote for their student representatives without any monetary or grade requirements.",
      },
      {
        title: "Section 5.",
        paragraph:
          "Publications and announcements through institutionalized student media are protected from interference from student government.",
      },
      {
        title: "Section 6.",
        paragraph:
          "All Lowell clubs must be open to all members of the Lowell student body.",
      },
      {
        title: "Section 7.",
        paragraph:
          "Student organizations may impartially formulate committees that will assist in their duties.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        title: "Section 1.",
        paragraph:
          "Any fiscal policies and procedures not mentioned below are subject to district, local, state, and federal jurisdiction as interpreted by the Principal with advice from SBC. ",
      },
      {
        title: "Section 2.",
        paragraph:
          "Any extracurricular organization with an account with the School Accountant shall be under the jurisdiction of SBC and its policies. Each organization needs to confer its budget and fiscal plans with the SBC Treasurer or whomever they appoint. The SBC Treasurer, along with advice from SBC and the Student Activities Director, shall have a clear set of policies and  procedures regarding fiscal matters. ",
      },
      {
        title: "Section 3.",
        paragraph:
          "All fundraising by all organizations, whether extracurricular or not, must be reviewed and approved by the SBC Treasurer. Any organization that fundraises without consent of SBC is subject to punishment by withholding profits or freezing accounts.",
      },
      {
        title: "Section 4.",
        paragraph:
          "The SBC has domain over the Student Body Council account and allocates its funds wherever and whenever necessary. Requests for funds from the aforementioned account shall be  presented to the SBC Treasurer along with necessary documents. ",
      },
      {
        title: "Subsection 1.",
        paragraph:
          "Any Lowell student organization in good standing with the SBC in need of financial aid shall have the opportunity to request funding from the SBC account through a written proposal submitted to the SBC Treasurer. ",
      },
      {
        title: "Subsection 2.",
        paragraph:
          "All requests for funding must be written with the interests of all Lowell students and to the benefit of the Lowell community. If possible, requests for funding must be submitted with a list of previous transactions detailing the past two years' monetary deposits and expenditures of the organization.",
      },
      {
        title: "Subsection 3.",
        paragraph:
          "Requests shall be subject to a vote by the SBC. Approved requests shall receive an affirmative majority. Requests approved by the SBC shall be announced to the entire LSA. Members of LSA who take issue with the approved request shall be able to request an all-LSA vote, requiring a majority to pass. The request shall be approved or denied within 10 school days after it is submitted. Within 60 days of the disbursement of funds, the organization shall submit an itemized list to the SBC detailing the usages of the funds allocated. All unused funds must be reimbursed to the Student Body Council account.",
      },
      {
        title: "Subsection 4.",
        paragraph:
          "All decisions are final and no requests may be resubmitted.",
      },
      {
        title: "Section 5.",
        paragraph:
          "The SBC Treasurer, by default, is the treasurer of any account without one already  predetermined. The Principal or Student Activities Director, by default, is the sponsor of any account without one already predetermined. ",
      },
      {
        title: "Section 6.",
        paragraph:
          "All interest from accounts with the School Accountant shall be installed into the Student Body Council account on the first day of the new fiscal year.",
      },
      {
        title: "Section 7.",
        paragraph:
      ...
      },
      {
        title: "Section 8.",
        paragraph:
          "During the spring semester, the senior class board shall submit monthly fiscal reports and budget proposals to the SBC Treasurer, SBC President, and the Student Activities Director for advice and review.",
      },
      {
        title: "Section 9.",
        paragraph:
          "Funds cannot be withdrawn from any account without the authorization of the School Accountant, the organization's sponsor, and respective treasurer. Transfers are authorized by the School Accountant, the giving organization's sponsor, and its treasurer.",
      },
      {
        title: "Section 10.",
        paragraph:
          "The SBC Treasurer, whenever they deem necessary, shall obtain a list of transactions from any organization specified in Section 2 for review by SBC. The SBC Treasurer, whenever they deem necessary, shall obtain a general ledger report for analysis by SBC.",
      },
    ],
  },
    ...
    sections: [
      {
        title: "Section 1.",
        paragraph:
          "Whenever two-thirds of the entire student government determine it necessary, shall  propose amendments to the Charter. ",
      },
      {
        title: "",
        paragraph: "",
    ...
    sections: [
      {
        title: "Section 1.",
        paragraph:
          "The ratification of three-fourths of the student body that votes shall be sufficient for the establishment of this Charter for Lowell student body.",
      },
    ],
  },
];
...
export default function Charter() {
  ...
  const constitution = CHARTER_PARAGRAPHS.map((p) => {
    return (
      <Glow color="red" key={p.article}>
        <div className="constitution glowable-text">
          <h2>{p.article}</h2>
          {p.sections.map((section, sectionIndex) => (
            <p key={`${section.title}-${section.paragraph}-${sectionIndex}`}>
              <strong>{section.title}</strong> {section.paragraph}
            </p>
          ))}
        </div>
      </Glow>
  ...
  return (
    <>
      ...
      <div
        className={`charter ${isCursive ? "charter--cursive" : "charter--readable"}`}
      >
        ...
        <p>
          *All pronouns “they” shall refer to all genders here forward in this
          Charter.
        </p>
        ...
        <GlowCapture className="charter-glow-capture">
          {constitution}
        </GlowCapture>
      </div>
    </>
